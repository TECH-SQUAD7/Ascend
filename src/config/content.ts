...
export const membershipTiers = [
  {
    ...
    price: `₹${paymentConfig.bronzePriceINR} / $${paymentConfig.bronzePriceUSD}`,
    seats: "40 seats",
    duration: "60 days",
    access: "Instant checkout/manual payment",
    note: "Best for getting your first clear revenue direction.",
    cta: "Join Founder Stream",
    featured: false,
    benefits: [
      ...
      "Founder-only Discord role and private updates",
  ...
  },
  {
    ...
    price: `₹${paymentConfig.platinumPriceINR} / $${paymentConfig.platinumPriceUSD}`,
    seats: "15 seats",
    duration: "90 days",
    access: "Instant checkout/manual payment",
    note: "Best for people who want more personal direction and feedback.",
    cta: "Join Builder Stream",
    featured: true,
    benefits: [
      ...
      "Priority Discord channel — replies within 48 weekday hours",
  ...
  },
  {
    ...
    price: `₹${paymentConfig.elitePriceINR} / $${paymentConfig.elitePriceUSD}`,
    seats: "5 seats",
    duration: "1 year",
    access: "Application first, approval before payment",
    note: "Best for deeper support across a full year of building.",
    cta: "Apply for Ascend Circle",
    featured: false,
    benefits: [
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Members receive path-finding resources, revenue sprint materials, founder updates, Discord access, and priority access depending on their tier.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Payments are manual for this early version. Bronze and Platinum open payment instructions, then an onboarding form after payment confirmation.",
  },
  {
    question: "How does Elite approval work?",
    answer:
      "Elite starts with an application. If approved, payment instructions are shared before onboarding into Ascend Circle.",
  },
  {
    question: "When does the MVP launch?",
    answer:
      "The MVP is being shaped with founding members. Early members get private updates and priority access as features become ready.",
  },
];
